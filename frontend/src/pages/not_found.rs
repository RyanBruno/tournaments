  ...
  rsx! {
    div { style: "min-height: 100vh; background-color: #f9fafb; display: flex; align-items: center; justify-content: center; font-family: sans-serif;",
      div { style: "text-align: center; max-width: 28rem; padding: 2rem;",
        h1 { style: "font-size: 3rem; font-weight: bold; color: #4f46e5; margin-bottom: 1rem;", "404" }
        ...
        Link {
          to: Route::Homepage {},
          style: "display: inline-block; margin-top: 2rem; background-color: #4f46e5; color: white; font-weight: 600; padding: 0.75rem 1.5rem; border-radius: 0.5rem; text-decoration: none;",
          "Back to Home"
        }
      }
    }
